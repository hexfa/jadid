...
<html lang="en" class=" is-copy-enabled">
  <head prefix="og: http://ogp.me/ns# fb: http://ogp.me/ns/fb# object: http://ogp.me/ns/object# article: http://ogp.me/ns/article# profile: http://ogp.me/ns/profile#">
    ...
    <link rel="web-socket" href="wss://live.github.com/_sockets/MTU3MTM2NTk6YTlmZTFkNjk4OWJiMzY5OTNmZjVhZDU4ODk5YjRkZTc6YzIzYzdiNzcwZjYzZDA4MWY3MThhNjY0NmNjZjc5ZDVlNmFjZmI5MTdhZTNjODg0YTcyNjhiYjIwNzJhNmVmNg==--d118f47501b0c57eba8a414eb2dadfee3d3896e6">
...
<meta content="collector.githubapp.com" name="octolytics-host" /><meta content="github" name="octolytics-app-id" /><meta content="BC9F28B0:6796:1EDA3C79:564217AF" name="octolytics-dimension-request_id" /><meta content="15713659" name="octolytics-actor-id" /><meta content="hexfa" name="octolytics-actor-login" /><meta content="26bbed3bec9b2bf919130d74809f04fe0bf7cb67dae249e9d4935a97616bb62c" name="octolytics-actor-hash" />
...
<meta content="Rails, view, blob#show" data-pjax-transient="true" name="analytics-event" />
  ...
  <meta class="js-ga-set" name="dimension1" content="Logged In">
    ...
    <meta name="user-login" content="hexfa">

      <link rel="mask-icon" href="https://assets-cdn.github.com/pinned-octocat.svg" color="#4078c0">
      <link rel="icon" type="image/x-icon" href="https://assets-cdn.github.com/favicon.ico">

    <meta content="972c0db8a4bfee7909b707177eb833c3070cfe8d" name="form-nonce" />
...
<ul class="header-nav user-nav right" id="user-links">
  <li class="header-nav-item">
      <span class="js-socket-channel js-updatable-content"
        data-channel="notification-changed:hexfa"
...
<a class="dropdown-item" href="/new" data-ga-click="Header, create new repository">
  ...
  <li class="header-nav-item dropdown js-menu-container">
    <a class="header-nav-link name tooltipped tooltipped-s js-menu-target" href="/hexfa"
       aria-label="View profile and more"
       data-ga-click="Header, show menu, icon:avatar">
      <img alt="@hexfa" class="avatar" height="20" src="https://avatars1.githubusercontent.com/u/15713659?v=3&amp;s=40" width="20" />
      <span class="dropdown-caret"></span>
    </a>
    ...
    <div class="dropdown-menu-content js-menu-content">
      <div class="dropdown-menu  dropdown-menu-sw">
        <div class=" dropdown-header header-nav-current-user css-truncate">
            Signed in as <strong class="css-truncate-target">hexfa</strong>
        ...
        <div class="dropdown-divider"></div>
          ...
          <a class="dropdown-item" href="/hexfa" data-ga-click="Header, go to profile, text:your profile">
            Your profile
          </a>
        ...
        <a class="dropdown-item" href="https://help.github.com" data-ga-click="Header, go to help, text:help">
          ...
          <!-- </textarea> --><!-- '"` --><form accept-charset="UTF-8" action="/logout" class="logout-form" data-form-nonce="972c0db8a4bfee7909b707177eb833c3070cfe8d" method="post"><div style="margin:0;padding:0;display:inline"><input name="utf8" type="hidden" value="&#x2713;" /><input name="authenticity_token" type="hidden" value="ysReLXDLJgNoP0eG0xlOrGEPrtkUR6fkiSSulGnJMxfuZCi179NjMyoN/FnMHTKXW2kLHUlYDLA7leCL/nLa+Q==" /></div>
...
<ul class="pagehead-actions">
  ...
  <li>
        <!-- </textarea> --><!-- '"` --><form accept-charset="UTF-8" action="/notifications/subscribe" class="js-social-container" data-autosubmit="true" data-form-nonce="972c0db8a4bfee7909b707177eb833c3070cfe8d" data-remote="true" method="post"><div style="margin:0;padding:0;display:inline"><input name="utf8" type="hidden" value="&#x2713;" /><input name="authenticity_token" type="hidden" value="sRtmqTATM9NCm86yaNk9aKyDoCD5eW5jzSu4Jjs/M2QvtCwDEP0kHmGmCffpFNFY+fhs2CcuoSis4mM2rQaidA==" /></div>      <input id="repository_id" name="repository_id" type="hidden" value="6898382" />
  ...
  <div class="js-toggler-container js-social-container starring-container ">
    ...
    <!-- </textarea> --><!-- '"` --><form accept-charset="UTF-8" action="/apache/cordova-js/unstar" class="js-toggler-form starred js-unstar-button" data-form-nonce="972c0db8a4bfee7909b707177eb833c3070cfe8d" data-remote="true" method="post"><div style="margin:0;padding:0;display:inline"><input name="utf8" type="hidden" value="&#x2713;" /><input name="authenticity_token" type="hidden" value="YGcIAjtzTwCG1BNRdDqnCXjX6hCMIiQxwE3A1s3NyODvAfu2a19SV7DKluE1DfKbWMdKhJ4QFbwxUKUi0srBBA==" /></div>
      <button
    ...
    <!-- </textarea> --><!-- '"` --><form accept-charset="UTF-8" action="/apache/cordova-js/star" class="js-toggler-form unstarred js-star-button" data-form-nonce="972c0db8a4bfee7909b707177eb833c3070cfe8d" data-remote="true" method="post"><div style="margin:0;padding:0;display:inline"><input name="utf8" type="hidden" value="&#x2713;" /><input name="authenticity_token" type="hidden" value="rrs09OvHudQEH8eRaKC1qLAsfx84zBp7ptcPQ9mnOOcMGxhGWPv/9K9EJIq8JvGGIFSuo+v+lZpmArbojr6FxA==" /></div>
      <button
        class="btn btn-sm btn-with-count js-toggler-target"
  ...
  <li>
          <!-- </textarea> --><!-- '"` --><form accept-charset="UTF-8" action="/apache/cordova-js/fork" class="btn-with-count" data-form-nonce="972c0db8a4bfee7909b707177eb833c3070cfe8d" method="post"><div style="margin:0;padding:0;display:inline"><input name="utf8" type="hidden" value="&#x2713;" /><input name="authenticity_token" type="hidden" value="la8Iae8y3qf6GkXG5fESqEo++ulpouwuCBRFp1GNPiF/UyvRsbS1Xb7ypi1ppsgJt8s+LIFMZZWqwuHguUFv/A==" /></div>
            <button
                type="submit"
...
<div class="js-clone-url clone-url "
  ...
  <div class="input-group js-zeroclipboard-container">
    <input type="text" class="input-mini text-small text-muted input-monospace js-url-field js-zeroclipboard-target"
           value="git@github.com:apache/cordova-js.git" readonly="readonly" aria-label="SSH clone URL">
    <span class="input-group-button">
      <button aria-label="Copy to clipboard" class="js-zeroclipboard btn btn-sm zeroclipboard-button tooltipped tooltipped-s" data-copied-hint="Copied!" type="button"><span class="octicon octicon-clippy"></span></button>
    </span>
  </div>
...
<div class="clone-options text-small text-muted">You can clone with
  <!-- </textarea> --><!-- '"` --><form accept-charset="UTF-8" action="/users/set_protocol?protocol_selector=http&amp;protocol_type=clone" class="inline-form js-clone-selector-form is-enabled" data-form-nonce="972c0db8a4bfee7909b707177eb833c3070cfe8d" data-remote="true" method="post"><div style="margin:0;padding:0;display:inline"><input name="utf8" type="hidden" value="&#x2713;" /><input name="authenticity_token" type="hidden" value="BcodcXMrKJ+piSjc6HssRQQTuAbIm4Qjt07nzUW5JKpBUws4RiKBvJ9eXNh9NaQmYI/qFDHr936+zOWbSTaJxw==" /></div><button class="btn-link js-clone-selector" data-protocol="http" type="submit">HTTPS</button></form>, <!-- </textarea> --><!-- '"` --><form accept-charset="UTF-8" action="/users/set_protocol?protocol_selector=ssh&amp;protocol_type=clone" class="inline-form js-clone-selector-form is-enabled" data-form-nonce="972c0db8a4bfee7909b707177eb833c3070cfe8d" data-remote="true" method="post"><div style="margin:0;padding:0;display:inline"><input name="utf8" type="hidden" value="&#x2713;" /><input name="authenticity_token" type="hidden" value="oBpaZXaPndt06/wPDpESNzhESbag50s3GtLYc7xfN34j35iZmgynLV9Fq6xuaGE5xzkj1mV8aBpR47v8WJ9LVA==" /></div><button class="btn-link js-clone-selector" data-protocol="ssh" type="submit">SSH</button></form>, or <!-- </textarea> --><!-- '"` --><form accept-charset="UTF-8" action="/users/set_protocol?protocol_selector=subversion&amp;protocol_type=clone" class="inline-form js-clone-selector-form is-enabled" data-form-nonce="972c0db8a4bfee7909b707177eb833c3070cfe8d" data-remote="true" method="post"><div style="margin:0;padding:0;display:inline"><input name="utf8" type="hidden" value="&#x2713;" /><input name="authenticity_token" type="hidden" value="kpgcdNZMAoRH8DW8VvW5ZiszUBWMYbjnZA95ARQTnKDRgpOy0rS1Zu6kAHj8urOVF4zacK2/nS5WhoQ8M3FaFQ==" /></div><button class="btn-link js-clone-selector" data-protocol="subversion" type="submit">Subversion</button></form>.
  ...
  <div class="file-actions">
    ...
    <div class="btn-group">
      ...
      <a href="/apache/cordova-js/commits/master/src/cordova.js" class="btn btn-sm " rel="nofollow">History</a>
        ...
        <!-- </textarea> --><!-- '"` --><form accept-charset="UTF-8" action="/apache/cordova-js/edit/master/src/cordova.js" class="inline-form js-update-url-with-hash" data-form-nonce="972c0db8a4bfee7909b707177eb833c3070cfe8d" method="post"><div style="margin:0;padding:0;display:inline"><input name="utf8" type="hidden" value="&#x2713;" /><input name="authenticity_token" type="hidden" value="Nci2165K1l/9lQRnHdw+HpcuD8Yos8edYoyb3R/OuhjPBe16QWSEZnu+lEeF13J5evf5a7MBf7YaeA8BoLaQnQ==" /></div>
          <button class="octicon-btn tooltipped tooltipped-nw" type="submit"
            aria-label="Fork this project and edit the file" data-hotkey="e" data-disable-with>
            <span class="octicon octicon-pencil"></span>
          </button>
</form>        <!-- </textarea> --><!-- '"` --><form accept-charset="UTF-8" action="/apache/cordova-js/delete/master/src/cordova.js" class="inline-form" data-form-nonce="972c0db8a4bfee7909b707177eb833c3070cfe8d" method="post"><div style="margin:0;padding:0;display:inline"><input name="utf8" type="hidden" value="&#x2713;" /><input name="authenticity_token" type="hidden" value="/XuMjrwlNFFWeiJ8VOA0cZmzpY9HgH6uPH30kZMTwDB8Dy1dVmpJjyFso9R1AzlZU6FtpGXHsthYpXFisvDpWw==" /></div>
...
<div id="jump-to-line" style="display:none">
  ...
  <div class="site-footer" role="contentinfo">
    ...
    <ul class="site-footer-links">
      <li>&copy; 2015 <span title="0.11442s from github-fe137-cp1-prd.iad.github.net">GitHub</span>, Inc.</li>
